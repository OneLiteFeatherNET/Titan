...
| B | sit-spawn | 2.1–2.2 | sonnet | `app/src/{main,test}/.../feature/{sit,spawn}/**` | `module/**`, `bootstrap/**`, `common/**`, andere Features |
| B | tickle-elytra | 2.3–2.4 | sonnet | `app/src/{main,test}/.../feature/{tickle,elytra}/**` | `module/**`, `bootstrap/**`, `common/**`, andere Features |
| B | navigator | 2.5 | sonnet | `app/src/{main,test}/.../feature/navigator/**`, `app/src/{main,test}/.../module/navigator/**` | übrige `module/**`, `bootstrap/**`, `common/**`, andere Features |
