...
- [x] 4.2 Lokale Abnahme im Client durch den Maintainer: Die Lobby verhält sich unverändert (Feder und Navigator, Sitzen, Kitzeln, Elytra, Höhen-Teleport, Respawn). Verifikation: Die Checkliste im PR ist abgehakt.
