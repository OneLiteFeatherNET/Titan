...
class TitanTranslationsTest {
    ...
    private static final List<String> KEY_CONSTANTS = List.of(
            TitanTranslations.CONFIG_RELOAD_UNCHANGED, TitanTranslations.CONFIG_RELOAD_APPLIED, TitanTranslations.CONFIG_RELOAD_APPLIED_NO_MODULES, TitanTranslations.CONFIG_RELOAD_REJECTED, TitanTranslations.CONFIG_RELOAD_FAILED, TitanTranslations.CONFIG_RELOAD_DISABLED
    );
