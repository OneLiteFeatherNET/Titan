...
class ArchitectureTest {
     ...
     * {@code openspec/changes/avaje-dependency-injection/design.md}.
     */
    private static final DescribedPredicate<JavaClass> PUBLIC_FEATURE_API = DescribedPredicate.describe("named '*Module' or '*Config', nested in a class named '*Config', or generated by Avaje Inject", javaClass -> isModuleOrConfigOrNestedInConfig(javaClass) || javaClass.isAnnotatedWith(Generated.class));

    /**
     * True for {@link Titan}, {@link TitanApplication}, or a class in
     * {@code net.onelitefeather.titan.app.bootstrap} - the lobby's composition root. Since
     * {@code avaje-dependency-injection}, {@code app.bootstrap.PlatformBeans} does what
     ...
     * {@code openspec/changes/avaje-dependency-injection/design.md}, decision 3.
     */
    private static final DescribedPredicate<JavaClass> IS_COMPOSITION_ROOT = DescribedPredicate.describe("is the composition root (Titan, TitanApplication, or app.bootstrap..)", javaClass -> javaClass.isEquivalentTo(Titan.class) || javaClass.isEquivalentTo(TitanApplication.class) || javaClass.getPackageName().equals(BOOTSTRAP_PACKAGE));
