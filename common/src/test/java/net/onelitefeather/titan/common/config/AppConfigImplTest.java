...
class AppConfigImplTest {
	...
	void testConstructorAndGetters() {
		...
		// Act
		AppConfigImpl appConfig = new AppConfigImpl(tickleDuration, sitOffset, allowedSitBlocks, simulationDistance,
				fireworkBoostSlot, elytraBoostMultiplier, minHeightBeforeTeleport, maxHeightBeforeTeleport);
	...
	void testDisplayConfig() {
		// Arrange
		AppConfigImpl appConfig = new AppConfigImpl(1000L, new Vec(0, 1.5, 0), List.of(Key.key("minecraft:oak_stairs")),
				10, 8, 1.5, -64, 320);
	...
	void testEqualsAndHashCode() {
		// Arrange
		AppConfigImpl appConfig1 = new AppConfigImpl(1000L, new Vec(0, 1.5, 0),
				List.of(Key.key("minecraft:oak_stairs")), 10, 8, 1.5, -64, 320);

		AppConfigImpl appConfig2 = new AppConfigImpl(1000L, new Vec(0, 1.5, 0),
				List.of(Key.key("minecraft:oak_stairs")), 10, 8, 1.5, -64, 320);
