...
class SitHelperTest {
    ...
    void testArrowTicking(Env env) {
        ...
        Assertions.assertNull(instance.getEntityByUuid(arrowUuid), "Arrow entity should be removed after ticking with no passengers");
    }
    ...
    void testIntegrationSitAndRemove(Env env) {
        ...
        Pos expectedArrowPos = new Pos(sitLocation.x() + sitOffset.x(), sitLocation.y() + sitOffset.y(), sitLocation.z() + sitOffset.z());
        Assertions.assertEquals(expectedArrowPos.x(), arrow.getPosition().x(), 0.001, "Arrow X position should match expected position");
        Assertions.assertEquals(expectedArrowPos.y(), arrow.getPosition().y(), 0.001, "Arrow Y position should match expected position");
        Assertions.assertEquals(expectedArrowPos.z(), arrow.getPosition().z(), 0.001, "Arrow Z position should match expected position");
        ...
        Assertions.assertEquals(playerPos.x(), player.getPosition().x(), 0.001, "Player X position should match original position");
        Assertions.assertEquals(playerPos.y(), player.getPosition().y(), 0.001, "Player Y position should match original position");
        Assertions.assertEquals(playerPos.z(), player.getPosition().z(), 0.001, "Player Z position should match original position");
